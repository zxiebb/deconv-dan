...
if DATASET == 'breast_cancer_atlas':
    TRAIN_DATASET_NAME = "breast_cellprotein_reference.csv"
    TRAIN_ANNOTATION_NAME = "breast_annotation_reference.csv"
    TARGET_DATASET_NAME = "breast_cellprotein_target.csv"
    TARGET_ANNOTATION_NAME = "breast_annotation_target.csv"
    TYPE_LIST = ['VA', 'AV', 'BA', 'FI', 'HS', 'IM']
    TARGET_TYPE = "simulated"
elif DATASET == 'breast_cluster':
    TRAIN_DATASET_NAME = "reference_breast_cellprotein_cluster.csv"
    TRAIN_ANNOTATION_NAME = "reference_breast_annotation_cluster.csv"
    TARGET_DATASET_NAME  = "target_breast_cellprotein_cluster.csv"
    TARGET_ANNOTATION_NAME = "target_breast_annotation_cluster.csv"
    TYPE_LIST = ['AV1','AV2','AV3','BA','FI1','FI2','HS','IM1','IM2','IM3','IM4','PE1','PE2','VA1','VA2','VA3']
    TARGET_TYPE = "simulated"
elif DATASET == 'breast_cluster_epithelial':
    TRAIN_DATASET_NAME = "reference_breast_cellprotein_epithelial.csv"
    TRAIN_ANNOTATION_NAME = "reference_breast_annotation_epithelial.csv"
    TARGET_DATASET_NAME  = "target_breast_cellprotein_epithelial.csv"
    TARGET_ANNOTATION_NAME = "target_breast_annotation_epithelial.csv"
    ...
    TRAIN_ANNOTATION_NAME = 'murine_annotation_N2.csv'
    TARGET_DATASET_NAME  = 'murine_cellprotein_nanoPOTS.csv'
    TARGET_ANNOTATION_NAME = 'murine_annotation_nanoPOTS.csv'
    TYPE_LIST = ['C10', 'SVEC', 'RAW']
    TARGET_TYPE = "simulated"
elif DATASET == 'murine_cellline_simulated_reverse_direction':
    TRAIN_DATASET_NAME ='murine_cellprotein_nanoPOTS.csv'
    TRAIN_ANNOTATION_NAME ='murine_annotation_nanoPOTS.csv'
    TARGET_DATASET_NAME =  'murine_cellprotein_N2.csv'
    TARGET_ANNOTATION_NAME =  'murine_annotation_N2.csv'
    TYPE_LIST = ['C10', 'SVEC', 'RAW']
    TARGET_TYPE = "simulated"
elif DATASET == 'murine_cellline':
    EXPERT_PROPORTION=np.array([1,0,0])  
    TRAIN_DATASET_NAME = 'murine_cellprotein_N2.csv'
    TRAIN_ANNOTATION_NAME = 'murine_annotation_N2.csv'
    TARGET_DATASET_NAME ="murine_target_x.csv"
    TYPE_LIST = ['C10', 'SVEC', 'RAW']
elif DATASET  == 'CDC_mel_to_mon':
    TRAIN_DATASET_NAME = 'melanoma.csv'
    TRAIN_ANNOTATION_NAME = 'annotation_CDC.csv'
    TARGET_DATASET_NAME  = 'monocyte.csv'
    TARGET_ANNOTATION_NAME = 'annotation_CDC.csv'
    TYPE_LIST = ['G1','S','G2']
    TARGET_TYPE = "simulated"
elif DATASET == 'CDC_mon_to_mel':
    TRAIN_DATASET_NAME = 'monocyte_full.csv'
    TRAIN_ANNOTATION_NAME = 'annotation_CDC.csv'
    TARGET_DATASET_NAME  = 'melanoma_full.csv'
    TARGET_ANNOTATION_NAME = 'annotation_CDC.csv'
    TYPE_LIST = ['G1','S','G2']
    TARGET_TYPE = "simulated"
elif DATASET == 'human_cellline':
    TRAIN_DATASET_NAME = 'glioma_cellprotein_reference_clean.csv'
    TRAIN_ANNOTATION_NAME = 'glioma_annotation_reference_clean.csv'
    TARGET_DATASET_NAME  = 'glioma_cellprotein_target.csv'
    TYPE_LIST = ['CT', 'IT', 'LE', 'PAN', 'MVP']
    EXPERT_PROPORTION=np.array([0.53,0.25,0.12,0.05,0.05])
elif DATASET == '450K':
    TRAIN_SAMPLE_NUM=1000
    EPOCHS = 50
    TRAIN_DATASET_NAME= 'reference_methylation_450K.csv'
    TRAIN_ANNOTATION_NAME = 'reference_annotation_450K.csv'
    TARGET_DATASET_NAME = 'GSE77797_selected.csv'
    TYPE_LIST = ['mono','b', 'cd8','cd4', 'NK','neu']
    EXPERT_PROPORTION=np.array([0,0,1/18,0,1/9,5/6])
elif DATASET == '450K_simulated':
    TRAIN_SAMPLE_NUM=1000
    EPOCHS = 50
    TRAIN_DATASET_NAME= 'reference_450K.csv'
    TRAIN_ANNOTATION_NAME = 'reference_450K_annotation.csv'
    TARGET_DATASET_NAME = 'target_450K.csv'
    TARGET_ANNOTATION_NAME = "target_450K_annotation.csv"
    TYPE_LIST = ['neu', 'nk', 'cd4','cd8','b','mono']
    TARGET_TYPE = "simulated"
elif DATASET == 'EPIC_simulated':
    TRAIN_SAMPLE_NUM=1000
    EPOCHS = 50
    TRAIN_DATASET_NAME= 'reference_EPIC.csv'
    TRAIN_ANNOTATION_NAME = 'reference_EPIC_annotation.csv'
    TARGET_DATASET_NAME = 'target_EPIC.csv'
    TARGET_ANNOTATION_NAME = "target_EPIC_annotation.csv"
    TYPE_LIST = ['neu', 'nk', 'cd4','cd8','b','mono']
    TARGET_TYPE = "simulated"
elif DATASET == 'sequencing':
    TRAIN_SAMPLE_NUM=1000
    EPOCHS = 50
    TRAIN_DATASET_NAME= 'reference_sequencing.csv'
    TRAIN_ANNOTATION_NAME = 'reference_sequencing_annotation.csv'
    TARGET_DATASET_NAME = 'target_sequencing.csv'
    TARGET_ANNOTATION_NAME = "target_sequencing_annotation.csv"
    TYPE_LIST = ['neu', 'nk', 'cd4','cd8','b','mono']
    TARGET_TYPE = "simulated"
CCC_LIST=[]
RMSE_LIST=[]
...
if TARGET_TYPE=="simulated":
    EXPERT_PROPORTION=np.ones(CELLTYPE_NUM)/CELLTYPE_NUM
feature_num=0
