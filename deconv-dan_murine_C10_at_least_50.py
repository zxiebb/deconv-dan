...
TRAIN_DATASET_NAME= 'murine_N2_SCP_exp.csv'
TRAIN_ANNOTATION_NAME = 'murine_N2_SCP_meta.csv'
...
for good in range (1):
    ...
    g.manual_seed(seed)
    num_of_neighbors=5
    TARGET_DATASET_NAME = 'murine_C10_at_least_50_test_x_'+str(good)+'.csv'
