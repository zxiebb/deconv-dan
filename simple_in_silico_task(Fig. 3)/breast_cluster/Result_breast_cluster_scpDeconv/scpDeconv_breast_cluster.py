...
def get_option_list(good):
    option_list['data_dir'] = 'target_breast_cluster/'
    option_list['ref_dataset_name'] = "reference_breast_cellprotein.csv"
    option_list['ref_metadata_name'] ="reference_annotation_cluster_breast.csv"
    option_list['target_dataset_name'] ="breast_cluster_test_x_"+str(good)+".csv"
    option_list['target_metadata_name'] = None
    option_list['random_type'] = "celltype"
    option_list['type_list'] = ['AV1','AV2','AV3','BA','FI1','FI2','HS','IM1','IM2','IM3','IM4','PE1','PE2','VA1','VA2','VA3']
    option_list['ref_sample_num'] = 4000
    option_list['sample_size'] = 150
    ...
    option_list['SaveResultsDir'] = "Result_breast_cluster_scpDeconv/"
    return option_list
