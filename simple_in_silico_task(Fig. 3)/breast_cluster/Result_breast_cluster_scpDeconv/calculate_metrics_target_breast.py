...
RESULT_DIRECTORY=  'Result_breast_cluster_scpDeconv/'
...
for good in range (20):
    ...
    ground_truth=pd.read_csv(DATA_DIRECTORY+"breast_cluster_simulated_test_y_"+str(good)+".csv",index_col=0,header=0)
