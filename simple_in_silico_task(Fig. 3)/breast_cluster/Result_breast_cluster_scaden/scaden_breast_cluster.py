...
class BulkSimulator(object):
    ...
    def simulate(self):
        ...
        dataset_celltypes = "reference_annotation_cluster_breast.csv"
...
def training(
    ...
    preds.to_csv(DATASET+"target_predicted_fraction"+str(i)+".csv")
batch_size=128
learning_rate=0.0001
steps=5000
seed=0
...
cells=100
n_samples=5000
DATASET="Result_breast_cluster_scaden/"
for i in range(20):
    seed=i+100
    ...
    g = torch.Generator()
    g.manual_seed(seed)
    PREDICTION_DATA="target_breast_cluster/breast_cluster_test_x_"+str(i)+".csv"
