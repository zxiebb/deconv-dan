...
import random
DATASET = ''
DATA_DIRECTORY = 'target_breast_cluster/'
TRAIN_SAMPLE_NUM = 4000
TAREGT_SAMPLE_NUM = 1000
BATCH_SIZE = 100
EPOCHS = 30
LEARNING_RATE = 0.00001
RESULT_DIRECTORY= 'Result_breast_cluster/'
SAMPLE_SIZE=100
TARGET_TYPE="real"
parser = argparse.ArgumentParser()
parser.add_argument("--dataset", type=str, default='murine_cellline', help='The name of benchmarking datasets')
parser.add_argument("--cudaindex", type=str, default='1', help='The index of GPU')
args = parser.parse_args()
DATASET = args.dataset
INDEX=args.cudaindex
os.environ['CUDA_VISIBLE_DEVICES'] = INDEX
DATASET == 'breast_cluster'
TRAIN_DATASET_NAME = "reference_breast_cellprotein.csv"
TRAIN_ANNOTATION_NAME = "reference_annotation_cluster_breast.csv"
...
for good in range (20):
    ...
    g = torch.Generator()
    g.manual_seed(seed)
    TARGET_DATASET_NAME="breast_cluster_test_x_"+str(good)+".csv"
