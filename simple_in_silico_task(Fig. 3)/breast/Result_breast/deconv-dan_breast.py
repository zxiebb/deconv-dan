...
import random
DATASET = 'breast'
DATA_DIRECTORY = 'target_breast/'
TRAIN_SAMPLE_NUM = 4000
TAREGT_SAMPLE_NUM = 1000
BATCH_SIZE = 100
EPOCHS = 30
LEARNING_RATE = 0.00001
RESULT_DIRECTORY= 'Result_breast/'
SAMPLE_SIZE=100
TARGET_TYPE="real"
...
TRAIN_ANNOTATION_NAME = "reference_annotation_breast.csv"
...
for good in range (20):
    ...
    g = torch.Generator()
    g.manual_seed(seed)
    TARGET_DATASET_NAME="breast_simulated_test_x_"+str(good)+".csv"
