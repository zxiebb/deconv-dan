...
def get_option_list(good):
    option_list['data_dir'] = 'target_breast/'
    option_list['ref_dataset_name'] = "reference_breast_cellprotein.csv"
    option_list['ref_metadata_name'] ="reference_annotation_breast.csv"
    option_list['target_dataset_name'] ="breast_simulated_test_x_"+str(good)+".csv"
    option_list['target_metadata_name'] = None
    option_list['random_type'] = "celltype"
    option_list['type_list'] = ['VA', 'AV', 'BA', 'FI', 'HS', 'IM']
    ...
    option_list['SaveResultsDir'] = "Result_breast_scpDeconv/"
    return option_list
