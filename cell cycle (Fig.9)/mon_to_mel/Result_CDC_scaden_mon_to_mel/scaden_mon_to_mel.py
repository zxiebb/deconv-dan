...
class BulkSimulator(object):
    ...
    def simulate(self):
        dataset_counts = "monocyte.csv"
        dataset_celltypes = "annotation_CDC.csv"
...
cells=100
n_samples=5000
DATASET="Result_CDC_scaden_mon_to_mel/"
for i in range(20):
    seed=i+100
    ...
    g = torch.Generator()
    g.manual_seed(seed)
    PREDICTION_DATA="target_CDC_mon_to_mel/CDC_mon_to_mel_test_x_"+str(i)+".csv"
