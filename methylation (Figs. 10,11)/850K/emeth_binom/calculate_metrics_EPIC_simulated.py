...
RESULT_DIRECTORY= 'D:/Data/Methylation/850K_simulated/target_EPIC_simulated/emeth_binom/'
...
for good in range (20):
    prediction=pd.read_csv(RESULT_DIRECTORY+"emeth_binom"+str(good)+".csv",index_col=0,header=0)
