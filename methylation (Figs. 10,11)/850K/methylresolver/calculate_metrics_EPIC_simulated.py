...
import random
DATASET = 'EPIC'
DATA_DIRECTORY = 'D:/Data/Methylation/850K_simulated/target_EPIC_simulated/'
RESULT_DIRECTORY= 'D:/Data/Methylation/850K_simulated/target_EPIC_simulated/methylresolver/'
...
for good in range (20):
    ...
    ground_truth=pd.read_csv(DATA_DIRECTORY+"EPIC_simulated_test_y_"+str(good)+".csv",index_col=0,header=0)
