...
RESULT_DIRECTORY= 'D:/Data/Methylation/sequencing_simulated/target_sequencing_simulated/icedt/'
...
for i in range(6):
    ...
    for good in range (20):
        prediction=pd.read_csv(RESULT_DIRECTORY+"icedt"+str(good)+".csv",index_col=0,header=0)
