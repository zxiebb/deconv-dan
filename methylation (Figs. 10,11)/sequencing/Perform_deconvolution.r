...
dataset<-0
for (dataset in 0:19){
props_path<-paste(DIR,"target_sequencing_simulated/sequencing_test_y_",sep="")
props_path<-paste(props_path,dataset,sep="")
props_path<-paste(props_path,".csv",sep="")
props<-read.csv(props_path, row.names = 1)
ref_path<-paste(DIR,"target_sequencing_simulated/reference_sequencing_mean_value.csv",sep="")
ref <- read.csv(ref_path, row.names = 1)
target_path<-paste(DIR,"target_sequencing_simulated/sequencing_test_x_",sep="")
